...
#SBATCH --job-name OpticalFlowTVL1-validation
...
if [ ! -d "ocf-optical-flow-tvl1" ]; then
    echo "Repo does not exist; cloning..."
    git clone https://github.com/alan-turing-institute/ocf-optical-flow-tvl1.git
fi
cd ocf-optical-flow-tvl1
